...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, difficulty):
        ...
        super().__init__()
        self.image = load_image("enemy.png", 40, 70)  # ← УБРАЛ "assets/"
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self):
        ...
        super().__init__()
        self.image = load_image("obstacle.png", 40, 40)  # ← УБРАЛ "assets/"
...
class PowerUp(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = load_image(img_name, 30, 30)  # ← этот уже был правильный
        self.rect = self.image.get_rect(center=(random.choice(LANES), -50))
